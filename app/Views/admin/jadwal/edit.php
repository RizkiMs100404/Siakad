...
<div class="max-w-xl mx-auto bg-white p-8 rounded-2xl shadow-xl mt-10 border border-amber-100">
    ...
    <form action="<?= base_url('admin/jadwal/update/'.$jadwal['id']) ?>" method="post" class="space-y-5">
        <?= csrf_field() ?>
        <div class="flex gap-3">
            <div class="flex-1">
                ...
                <select name="kelas_id" class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-100/40 transition <?= (session('errors.kelas_id') ? 'border-red-400' : '') ?>">
            ...
            <div class="flex-1">
                ...
                <select name="mapel_id" class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-100/40 transition <?= (session('errors.mapel_id') ? 'border-red-400' : '') ?>">
        ...
        <div class="flex gap-3">
            <div class="flex-1">
                ...
                <select name="guru_id" class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-100/40 transition <?= (session('errors.guru_id') ? 'border-red-400' : '') ?>">
            ...
            <div class="flex-1">
                ...
                <select name="hari"
                    class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-100/40 transition <?= (session('errors.hari') ? 'border-red-400' : '') ?>">
        ...
        <div class="flex gap-3">
            <div class="flex-1">
                ...
                <input type="time" name="jam_mulai" value="<?= old('jam_mulai', $jadwal['jam_mulai']) ?>"
                    class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-100/40 transition <?= (session('errors.jam_mulai') ? 'border-red-400' : '') ?>">
            </div>
            <div class="flex-1">
                <label class="block text-sm font-medium text-gray-700 mb-1 flex items-center gap-1">
                ...
                <input type="time" name="jam_selesai" value="<?= old('jam_selesai', $jadwal['jam_selesai']) ?>"
                    class="w-full border border-gray-300 rounded-xl px-4 py-2 focus:border-amber-500 focus:ring-2 focus:ring-amber-100/40 transition <?= (session('errors.jam_selesai') ? 'border-red-400' : '') ?>">
            </div>
        </div>
