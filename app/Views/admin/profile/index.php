...
<div class="max-w-3xl mx-auto mt-8 p-8 bg-white rounded-2xl shadow-lg flex flex-col md:flex-row gap-8">
    <div class="flex flex-col items-center w-full md:w-1/3 gap-3">
        ...
        <form action="<?= base_url('admin/profile/update') ?>" method="post" enctype="multipart/form-data" class="w-full mt-4">
            <?= csrf_field() ?>
    ...
    <div class="flex-1 flex flex-col gap-8">
        <!-- Info -->
        <form action="<?= base_url('admin/profile/update') ?>" method="post" enctype="multipart/form-data" class="space-y-4">
            <?= csrf_field() ?>
            <div>
        ...
        <!-- Ganti Password -->
        <form action="<?= base_url('admin/profile/password') ?>" method="post" class="space-y-4 bg-blue-50 rounded-xl p-6 shadow-inner">
            <?= csrf_field() ?>
